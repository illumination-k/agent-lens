...
//! communities, similarity, wrapper, hotspot, risk, co-change,
//! change-entropy, …) and is wired to a clap subcommand so typos surface
//! at parse time. Output is always written to stdout as JSON
