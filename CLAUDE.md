...
- On-demand analyzers that report codebase shape: duplication, wrappers, cohesion, complexity, coupling, context span, hotspots, and call-graph structure (hubs, cycles, queries, impact, layers, untested).
